export default {
  ...
  examples: {
    ...
    skewableBox: 'Skewable Box',
    dragEdgesToSkew: 'Drag edges to skew',
    combinedBox: 'All Features',
    allFeatures: 'Try all features',
  ...
  introduction: {
    title: 'ES Drager',
    lead: 'A lightweight React component for creating draggable, rotatable, scalable and skewable elements with connection capabilities.',
    overview: 'Overview',
    overviewDesc: 'ES Drager provides a simple yet powerful way to add drag, rotate, scale, resize, and skew functionality to any React component. With built-in support for connections, alignment guides, position constraints, and snapping, it\'s perfect for building:',
    usecase: {
  ...
  quickStart: {
    ...
    addingFeaturesDesc: 'Enable rotation, scaling, and skewing with simple props:',
  ...
  skew: {
    title: 'Skew',
    desc: 'ES Drager provides skew transformation functionality through draggable handles on the edges of the element. This allows for intuitive skewing along X and Y axes.',
    basic: 'Basic Usage',
    basicDesc: 'To enable skewing, simply add the skewable prop to your Drager component:',
    handles: 'Skew Handles',
    handlesDesc: 'When skewable is enabled, four skew handles appear:',
    handlesHorizontal: 'Top and bottom edge handles control X-axis skew (horizontal shearing)',
    handlesVertical: 'Left and right edge handles control Y-axis skew (vertical shearing)',
    tip: 'Drag the blue squares on the edges to skew the element.',
    skewLimits: 'Skew Limits',
    skewLimitsDesc: 'You can limit the skew angles using minSkew and maxSkew props:',
    initialSkew: 'Initial Skew',
    initialSkewDesc: 'You can set initial skew angles using the skewX and skewY props:',
    skewEvents: 'Skew Events',
    skewEventsDesc: 'ES Drager provides an onSkew event for skew changes:',
    combining: 'Combining with Other Features',
    combiningDesc: 'Skew functionality can be combined with other features like rotation, scaling, and resizing:',
    skewableBox: 'Skewable Box',
    trySkewing: 'Try skewing me',
  },
  resize: {
    title: 'Resize',
  ...
  connections: {
    ...
    complexExampleDesc: 'Connections work seamlessly with rotation, scaling, and skewing:',
    node1: 'Node 1',
    node2: 'Node 2',
    node3: 'Node 3',
    tryConnections: 'Try creating connections between nodes while rotating, scaling, and skewing them. The connections will automatically update to maintain their positions.',
  },
  events: {
  ...
  props: {
    ...
    skewable: { description: 'Whether the element can be skewed.' },
    skewX: { description: 'Initial X-axis skew angle in degrees.' },
    skewY: { description: 'Initial Y-axis skew angle in degrees.' },
    minSkew: { description: 'Minimum skew angle.' },
    maxSkew: { description: 'Maximum skew angle.' },
    ...
    onSkew: { description: 'Called when skew changes with current skew values.' },
  ...
  types: {
    ...
    skewPositionDesc: 'Valid positions for skew handles.',
    example: 'Usage Example',
